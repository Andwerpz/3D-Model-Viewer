...
public class MathTools {
	...
	public static double aspectRatio = (double) Mesh.customResHeight / (double) Mesh.customResWidth;
	...
	public static Point3D scalePoint(Point3D p) {
		...
		ans.x = (p.x + 1d) * (0.5 * Mesh.customResWidth);
		ans.y = (p.y + 1d) * (0.5 * Mesh.customResHeight);
